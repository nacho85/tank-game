import { BOARD_HEIGHT, BOARD_WIDTH, HUD_SIDEBAR_WIDTH, SURVIVAL_BOARD_HEIGHT, SURVIVAL_BOARD_WIDTH } from "./constants.js";

export const GAME_WIDTH = Math.max(BOARD_WIDTH, SURVIVAL_BOARD_WIDTH) + HUD_SIDEBAR_WIDTH;
